...
export default class Root extends React.Component {
  constructor(props) {
    ...
    console.log(this.state.sequenceItems)
    ...
    return (
      <div>
        ...
        {sequenceItems.map((sequenceItem, index) => {
          return <SequenceItem ref={sequenceItemRefs[index]} key={sequenceItem.id} sequenceList={sequenceItems} sequenceItem={sequenceItem} onDelete={() => {
              const newSequenceItems = sequenceItems.slice()
