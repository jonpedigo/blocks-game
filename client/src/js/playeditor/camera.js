...
function drawNameAbove(ctx, object) {
  ...
  window.wrapText(ctx, object.name, (object.x+(object.width/2))*window.scaleMultiplier - camera.x, (((object.y*window.scaleMultiplier) - camera.y) - fontSize), lineWidth, fontSize)
}
