...
function init() {
  ...
  var askHeroToWriteDialogue = document.getElementById("ask-hero-to-write-dialogue");
  askHeroToWriteDialogue.addEventListener('click', () => window.socket.emit('askHeroToWriteDialogue', window.objecteditor.get(), window.editingHero.id))
